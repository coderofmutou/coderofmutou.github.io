...
![FilterSecurityInterceptor.bmp]（安全框架之 Spring Security.assets\C38b0edDEb1711034791318-4b839450-b27a-472f-a61a-00e3606394df.bmp）
`ExceptionTranslationFilter`：是个异常过滤器，用来处理在认证授权过程中抛出的异常。
![ExceptionTranslationFilter.bmp]（安全框架之 Spring Security.assets\F9E78A11AB1711034804386-3ec8dbfc-8f07-4dc7-8119-b4630cb3b3ce.bmp）
`UsernamePasswordAuthenticationFilter` ：对/login 的 POST 请求做拦截，校验表单中用户名，密码。
![UsernamePasswordAuthenticationFilter .bmp]（安全框架之 Spring Security.assets\287e656c211711034807997-ada2495c-fa0a-4f21-8008-452ce0675f45.bmp）
...
![1.bmp]（安全框架之 Spring Security.assets\aa2c45CDD71706802405020-a58103b3-5190-4f4d-a382-37ddfd7e20c1.bmp）
返回值 UserDetails
...
boolean isEnabled();
```
![2.bmp]（安全框架之 Spring Security.assets\809bBEbC851706802592723-4599e3c9-52c8-470c-a8bd-faa9ffc4a745.bmp）
方法参数 username：表示用户名。此值是客户端表单传递过来的数据。默认情况下必须叫 username，否则无法接收。
但可以在配置类中通过以下方法修改：
![image.png]（安全框架之 Spring Security.assets\FbaE5DB92b1706803688705-d8b19cdf-1ee9-4282-9327-4725674d2c3b.png）
### PasswordEncoder 接口
```java
// 表示把参数按照特定的解析规则进行解析
...
```
接口实现类：
![3.bmp]（安全框架之 Spring Security.assets\e6da9DdfF51706802715081-12d2a7e5-1236-4927-9457-e6906b97e084.bmp）
...
![过程.bmp]（安全框架之 Spring Security.assets\C0FaDfdDAA1711036428762-f5cbfac2-3a98-4238-96d9-cb4985d4419a.bmp）
...
### 访问令牌JWT
![JWT.bmp]（安全框架之 Spring Security.assets\Be47C62fbA1711036511382-98c8f918-b082-4ae4-9a4c-c5d8f3e141b4.bmp）
### SpringSecurity 原理总结
...
<img src="%E5%AE%89%E5%85%A8%E6%A1%86%E6%9E%B6%E4%B9%8BSpring%20Security.assets/image-20240422214525224.png" alt="image-20240422214525224" style="zoom: 50%;" />
...
<img src="%E5%AE%89%E5%85%A8%E6%A1%86%E6%9E%B6%E4%B9%8BSpring%20Security.assets/image-20240422215055748.png" alt="image-20240422215055748" style="zoom: 50%;" />

<img src="%E5%AE%89%E5%85%A8%E6%A1%86%E6%9E%B6%E4%B9%8BSpring%20Security.assets/image-20240422215122699.png" alt="image-20240422215122699" style="zoom: 45%;" />

<img src="%E5%AE%89%E5%85%A8%E6%A1%86%E6%9E%B6%E4%B9%8BSpring%20Security.assets/image-20240422215152167.png" alt="image-20240422215152167" style="zoom:50%;" />

<img src="%E5%AE%89%E5%85%A8%E6%A1%86%E6%9E%B6%E4%B9%8BSpring%20Security.assets/image-20240422215214361.png" alt="image-20240422215214361" style="zoom:50%;" />

<img src="%E5%AE%89%E5%85%A8%E6%A1%86%E6%9E%B6%E4%B9%8BSpring%20Security.assets/image-20240422215231178.png" alt="image-20240422215231178" style="zoom:50%;" />

上述的 第二 过程调用了 `UsernamePasswordAuthenticationFilter` 的 `attemptAuthentication() `方法，源码如下：

<img src="%E5%AE%89%E5%85%A8%E6%A1%86%E6%9E%B6%E4%B9%8BSpring%20Security.assets/image-20240422215359136.png" alt="image-20240422215359136" style="zoom:50%;" />

<img src="%E5%AE%89%E5%85%A8%E6%A1%86%E6%9E%B6%E4%B9%8BSpring%20Security.assets/image-20240422215419826.png" alt="image-20240422215419826" style="zoom:50%;" />

<img src="%E5%AE%89%E5%85%A8%E6%A1%86%E6%9E%B6%E4%B9%8BSpring%20Security.assets/image-20240422215434883.png" alt="image-20240422215434883" style="zoom:50%;" />

上述的(3)过程创建的 `UsernamePasswordAuthenticationToken` 是 `Authentication` 接口的实现类，该类有两个构造器，一个用于封装前端请求传入的未认证的用户信息，一个用于封装认证成功后的用户信息：

<img src="%E5%AE%89%E5%85%A8%E6%A1%86%E6%9E%B6%E4%B9%8BSpring%20Security.assets/image-20240422215532309.png" alt="image-20240422215532309" style="zoom:50%;" />

`Authentication` 接口的实现类用于存储用户认证信息，查看该接口具体定义：

<img src="%E5%AE%89%E5%85%A8%E6%A1%86%E6%9E%B6%E4%B9%8BSpring%20Security.assets/image-20240422215608321.png" alt="image-20240422215608321" style="zoom:50%;" />
...
<img src="%E5%AE%89%E5%85%A8%E6%A1%86%E6%9E%B6%E4%B9%8BSpring%20Security.assets/image-20240422215814055.png" alt="image-20240422215814055" style="zoom:80%;" />

<img src="%E5%AE%89%E5%85%A8%E6%A1%86%E6%9E%B6%E4%B9%8BSpring%20Security.assets/image-20240422215855846.png" alt="image-20240422215855846" style="zoom:80%;" />

<img src="%E5%AE%89%E5%85%A8%E6%A1%86%E6%9E%B6%E4%B9%8BSpring%20Security.assets/image-20240422220007046.png" alt="image-20240422220007046" style="zoom:80%;" />

<img src="%E5%AE%89%E5%85%A8%E6%A1%86%E6%9E%B6%E4%B9%8BSpring%20Security.assets/image-20240422220029162.png" alt="image-20240422220029162" style="zoom:80%;" />
...
<img src="%E5%AE%89%E5%85%A8%E6%A1%86%E6%9E%B6%E4%B9%8BSpring%20Security.assets/image-20240422220125987.png" alt="image-20240422220125987" style="zoom: 80%;" />

##### 认证成功/失败处理

上述过程就是认证流程的最核心部分，接下来重新回到 `UsernamePasswordAuthenticationFilter` 过滤器的 `doFilter()` 方法，查看认证成功/失败的处理：

<img src="%E5%AE%89%E5%85%A8%E6%A1%86%E6%9E%B6%E4%B9%8BSpring%20Security.assets/image-20240422220235323.png" alt="image-20240422220235323" style="zoom:80%;" />

查看 `successfulAuthentication()` 和 `unsuccessfulAuthentication()` 方法源码

<img src="%E5%AE%89%E5%85%A8%E6%A1%86%E6%9E%B6%E4%B9%8BSpring%20Security.assets/image-20240422220550530.png" alt="image-20240422220550530" style="zoom:80%;" />

<img src="%E5%AE%89%E5%85%A8%E6%A1%86%E6%9E%B6%E4%B9%8BSpring%20Security.assets/24-%E8%AE%A4%E8%AF%81%E6%B5%81%E7%A8%8B%E4%B8%AD%E5%90%84%E6%A0%B8%E5%BF%83%E7%B1%BB%E5%92%8C%E6%8E%A5%E5%8F%A3%E7%9A%84%E5%85%B3%E7%B3%BB%E5%9B%BE.jpg" alt="24-认证流程中各核心类和接口的关系图" style="zoom:80%;" />
...
<img src="%E5%AE%89%E5%85%A8%E6%A1%86%E6%9E%B6%E4%B9%8BSpring%20Security.assets/image-20240422220805549.png" alt="image-20240422220805549" style="zoom: 80%;" />
...
<img src="%E5%AE%89%E5%85%A8%E6%A1%86%E6%9E%B6%E4%B9%8BSpring%20Security.assets/image-20240422220933151.png" alt="image-20240422220933151" style="zoom: 70%;" />
...
<img src="%E5%AE%89%E5%85%A8%E6%A1%86%E6%9E%B6%E4%B9%8BSpring%20Security.assets/image-20240422221118815.png" alt="image-20240422221118815" style="zoom: 50%;" />

- 在前面讲解认证成功的处理方法 `successfulAuthentication()` 时，有以下代码：

    <img src="%E5%AE%89%E5%85%A8%E6%A1%86%E6%9E%B6%E4%B9%8BSpring%20Security.assets/image-20240422221210869.png" alt="image-20240422221210869" style="zoom: 67%;" />

- 查看 SecurityContext 接口及其实现类 `SecurityContextImpl`， 该类其实就是对 Authentication 的封装

    <img src="%E5%AE%89%E5%85%A8%E6%A1%86%E6%9E%B6%E4%B9%8BSpring%20Security.assets/image-20240422221347113.png" alt="image-20240422221347113" style="zoom:40%;" />

- 查看  `SecurityContextHolder` 类 ， 该类其实是对 ThreadLocal 的 封 装 ， 存储 SecurityContext 对象

    <img src="%E5%AE%89%E5%85%A8%E6%A1%86%E6%9E%B6%E4%B9%8BSpring%20Security.assets/image-20240422221423767.png" alt="image-20240422221423767" style="zoom:40%;" />

    <img src="%E5%AE%89%E5%85%A8%E6%A1%86%E6%9E%B6%E4%B9%8BSpring%20Security.assets/image-20240422221444667.png" alt="image-20240422221444667" style="zoom:40%;" />

<img src="%E5%AE%89%E5%85%A8%E6%A1%86%E6%9E%B6%E4%B9%8BSpring%20Security.assets/image-20240422221511108.png" alt="image-20240422221511108" style="zoom:40%;" />
...
<img src="%E5%AE%89%E5%85%A8%E6%A1%86%E6%9E%B6%E4%B9%8BSpring%20Security.assets/image-20240422221927771.png" alt="image-20240422221927771" style="zoom: 50%;" />

<img src="%E5%AE%89%E5%85%A8%E6%A1%86%E6%9E%B6%E4%B9%8BSpring%20Security.assets/image-20240422222009702.png" alt="image-20240422222009702" style="zoom:60%;" />
