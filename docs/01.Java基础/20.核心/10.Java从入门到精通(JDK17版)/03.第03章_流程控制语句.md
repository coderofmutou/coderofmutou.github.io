...
![第1阶段：Java基本语法-第03章](images/第1阶段：Java基本语法-第03章.webp)
...
![image-20220514160139926](images/image-20220514160139926.webp)
...
|--------|---------|-----------------|--------|
| `break` | `switch-case`、循环结构 | 一旦执行，就结束（跳出）**当前**循环结构 | 关键字后面不能声明其他语句 |
| `continue` | 循环结构 | 一旦执行，就结束（跳出）**当次**循环结构 | 关键字后面不能声明其他语句 |
