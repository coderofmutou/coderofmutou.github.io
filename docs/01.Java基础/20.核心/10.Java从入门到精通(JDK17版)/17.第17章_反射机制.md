...
permalink: /java-basic/java-from-entry-to-proficiency/chapter-17/
categories:
  - Java基础
  - Java从入门到精通(JDK17版)
tags:
...
![第3阶段：Java高级应用-第17章](images/第3阶段：Java高级应用-第17章.webp)
...
![image-20220417161529285](images/image-20220417161529285.webp)

**从内存加载上看反射：**

![image-20220524101448625](images/image-20220524101448625.webp)
...
![image-20220417162559217](images/image-20220417162559217.webp)
...
![image-20220514180100176](images/image-20220514180100176.webp)
...
![image-20220417173459849](images/image-20220417173459849.webp)

### 3.2 类的加载过程

当程序主动使用某个类时，如果该类还未被加载到内存中，系统会通过加载、链接、初始化三个步骤来对该类进行初始化。如果没有意外，JVM 将会连续完成这三个步骤，所以有时也把这三个步骤统称为类加载。

![image-20220417171411631](images/image-20220417171411631.webp)
...
![image-20220417173647473](images/image-20220417173647473.webp)
...
![image-20220417173616344](images/image-20220417173616344.webp)
...
![image-20220417173819953](images/image-20220417173819953.webp)
...
![image-20220417174032702](images/image-20220417174032702.webp)
...
![image-20220417181700813](images/image-20220417181700813.webp)
