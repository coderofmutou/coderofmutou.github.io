...
![第2阶段：Java面向对象编程-第06章](images/第2阶段：Java面向对象编程-第06章.webp)
...
![中篇_第1章：JVM架构-简图](images/中篇_第1章：JVM架构-简图.webp)
...
可以，Java 给我们提供了 `构造器(Constructor)`，也称为构造方法。
