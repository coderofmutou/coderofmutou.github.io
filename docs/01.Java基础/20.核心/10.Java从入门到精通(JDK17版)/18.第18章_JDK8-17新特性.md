...
![jdkxintexing](images/jdkxintexing.webp)

#### JDK 9

Java 9 提供了 `超过150项` 新功能特性，包括备受期待的模块化系统、可交互的 REPL 工具：jshell，JDK 编译工具，Java 公共 API 和私有代码，以及安全增强、扩展提升、性能管理改善等。

特性太多，查看链接：[OpenJDK 9 特性列表](https://openjdk.java.net/projects/jdk9/)

#### JDK 10

[OpenJDK 10 特性列表](https://openjdk.java.net/projects/jdk/10/)
...
[OpenJDK 11 特性列表](https://openjdk.java.net/projects/jdk/11/)
...
[OpenJDK 12 特性列表](https://openjdk.java.net/projects/jdk/12/)
...
[OpenJDK 13 特性列表](https://openjdk.java.net/projects/jdk/13/)
...
[OpenJDK 14 特性列表](https://openjdk.java.net/projects/jdk/14/)
...
[OpenJDK 15 特性列表](https://openjdk.java.net/projects/jdk/15/)
...
[OpenJDK 16 特性列表](https://openjdk.java.net/projects/jdk/16/)
...
[OpenJDK 17 特性列表](https://openjdk.java.net/projects/jdk/17/)
...
[Oracle Java 历史版本下载](https://www.oracle.com/java/technologies/downloads/archive/)

![image-20220525200441935](images/image-20220525200441935.webp)

::: note 课程资料下载
链接：[尚硅谷 JDK8-17 课程资料（百度网盘）](https://pan.baidu.com/s/15QrBUOvfE9vjlTzN_EeVLg)

提取码：yyds
:::

![image-20221213235332866](images/image-20221213235332866.webp)
...
![lambda表达式](images/lambda表达式.webp)

![image-20221111213355625](images/image-20221111213355625.webp)
...
![image-20220527111751485](images/image-20220527111751485.webp)
...
::: tip 提示
我们还可以重新定义相同方法名和参数列表的方法，即对现有方法的修改（或覆盖）。
:::
...
2、这些资源实现类必须实现 AutoCloseable 或 Closeable 接口，实现其中的 clos() 方法。Closeable 是 AutoCloseable 的子接口。Java7 几乎把所有的“资源类”（包括文件 IO 的各种类、JDBC 编程的 Connection、Statement 等接口…）都进行了改写，改写后资源类都实现了 AutoCloseable 或 Closeable 接口，并实现了 close() 方法。
...
构造器的参数类型
 ...
 ![image-20220528155614708](images/image-20220528155614708.webp)
...
![image-20220527233322495](images/image-20220527233322495.webp)
...
![image-20220528212254705](images/image-20220528212254705.webp)
...
![image-20220528212323729](images/image-20220528212323729.webp)
...
![image-20220528212414676](images/image-20220528212414676.webp)

![image-20220528212421319](images/image-20220528212421319.webp)
