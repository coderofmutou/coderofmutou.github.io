---
title: 第 14 章_数据结构与集合源码
date: 2025-01-14 21:35:18
permalink: /java-basic/java-from-entry-to-proficiency/chapter-14/
categories: 
  - Java基础
  - Java从入门到精通(JDK17版)
tags:
...
![第3阶段：Java高级应用-第14章](images/第3阶段：Java高级应用-第14章.webp)

## 1. 数据结构剖析

我们举一个形象的例子来理解数据结构的作用：

![image-20220412011531879](images/image-20220412011531879.webp)
...
:::
 ...
 ![image-20220412011555025](images/image-20220412011555025.webp)

上图：没有战术，打仗事倍功半

 ![image-20220412011600845](images/image-20220412011600845.webp)
...
![image-20220824011022664](images/image-20220824011022664.webp)
...
![image-20220521100746910](images/image-20220521100746910.webp)
...
![image-20220521103734742](images/image-20220521103734742.webp)
...
![image-20220521115200921](images/image-20220521115200921.webp)
...
![image-20220521115734571](images/image-20220521115734571.webp)
...
![1563432676234](images/1563432676234.webp)

例如：对象数组

![1563432696340](images/1563432696340.webp)
...
![数据结构-一维数组](images/数据结构-一维数组.webp)
...
![image-20220511113744772](images/image-20220511113744772-1661445988505.webp)

- 常见的链表结构有如下的形式：


![1563448858180](images/1563448858180-1661445988506.webp)

![数据结构-链表](images/数据结构-链表.webp)

### 3.2 自定义链表

#### 3.2.1 自定义单向链表

![image-20221028195106363](images/image-20221028195106363.webp)
...
![image-20220514165707977](images/image-20220514165707977-1661448081075.webp)
...
- 栈按照 `先进后出(FILO,first in last out)` 的原则存储数据，先进入的数据被压入栈底，最后的数据在栈顶。每次删除（退栈）的总是删除当前栈中最后插入（进栈）的元素，而最先插入的是被放在栈的底部，要到最后才能删除。
   ...
   ![image-20221028192349993](images/image-20221028192349993.webp)
...
![image-20220826010258638](images/image-20220826010258638.webp)

![数据结构-栈](images/数据结构-栈.webp)
...
![image-20220826010241172](images/image-20220826010241172.webp)

![数据结构-队列](images/数据结构-队列.webp)

## 6. 树与二叉树

### 6.1 树的理解

![image-20220521111904272](images/image-20220521111904272.webp)
...
![1563449427345](images/1563449427345-1661447692846.webp)
...
![1574575739236](images/1574575739236-1661447692846.webp)
...
![image-20220521153016348](images/image-20220521153016348.webp)

1、**`满二叉树`**： 除最后一层无任何子节点外，每一层上的所有结点都有两个子结点的二叉树。 第 n 层的结点数是 2 的 n-1 次方，总的结点个数是 2 的 n 次方-1

![1574575163883](images/1574575163883-1661447692846.webp)

2、**`完全二叉树`**： 叶结点只能出现在最底层的两层，且最底层叶结点均处于次底层叶结点的左侧。

![1574575180247](images/1574575180247-1661447692846.webp)
...
![image-20220521145208018](images/image-20220521145208018.webp)
...
![image-20220521150151219](images/image-20220521150151219.webp)
...
2、`rotation`：将红黑树某些结点分支进行旋转（左旋或右旋）
 ...
 ![image-20221208212053079](images/image-20221208212053079.webp)
...
![1563549818689](images/1563549818689-1661447917313.webp)
...
![image-20221029112037297](images/image-20221029112037297.webp)

- **ArrayList 自动扩容过程**

![image-20221029112107691](images/image-20221029112107691.webp)

- **ArrayList 的 add(E e)方法**

![image-20221029112129161](images/image-20221029112129161.webp)

- **ArrayList 的 add(int index,E e)方法**

![image-20221029112157007](images/image-20221029112157007.webp)
...
![image-20221029134437888](images/image-20221029134437888.webp)

- **包含 4 个元素的 LinkedList**

![image-20221029134534198](images/image-20221029134534198.webp)

- **add(E e)方法**

![image-20221029135013377](images/image-20221029135013377.webp)

- **add(int index,E e)方法**

![image-20221029135045120](images/image-20221029135045120.webp)

- **remove(Object obj)方法**

![image-20221029134721089](images/image-20221029134721089.webp)

- **remove(int index)方法**

![image-20221029134807613](images/image-20221029134807613.webp)
...
![image-20221029144811305](images/image-20221029144811305.webp)
...
![image-20220514190849626](images/image-20220514190849626-1661448231966.webp)
...
![image-20220514190904009](images/image-20220514190904009-1661448231966.webp)
...
![image-20220524142524796](images/image-20220524142524796-1661448231966.webp)
...
![image-20221029145708224](images/image-20221029145708224.webp)
...
![1563797150134](images/1563797150134-1661448231965.webp)
...
![image-20220514190454633](images/image-20220514190454633-1661448231965.webp)
...
![1563800372286](images/1563800372286-1661448231966.webp)
...
![1563802656661](images/1563802656661-1661448231966.webp)

JDK1.8 之后使用：数组+链表/红黑树的结构。

![1563802665708](images/1563802665708-1661448231966.webp)
...
![HashMap的循环引用问题](images/HashMap的循环引用问题.webp)
