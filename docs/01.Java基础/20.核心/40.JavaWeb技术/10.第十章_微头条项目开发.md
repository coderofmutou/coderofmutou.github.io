...
permalink: /java-basic/java-web/chapter-10/
categories:
  - Java基础
  - 核心
  - JavaWeb技术
...
+ 进入项目后打开集成终端或者在 src 上右击选择在集成终端中打开
