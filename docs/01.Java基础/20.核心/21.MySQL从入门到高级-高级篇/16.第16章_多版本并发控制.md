...
![Concurrency_Issues_Isolation_Levels1.png](./images/Concurrency_Issues_Isolation_Levels1.png)
...
![Concurrency_Issues_MVCC.png](./images/Concurrency_Issues_MVCC.png)
...
![MVCC_Record_RollPointer.jpg](./images/MVCC_Record_RollPointer.jpg)
...
* `trx_ids`，表示在生成 ReadView 时当前系统中活跃的读写事务的`事务id列表`。 
...
![trx_ids.png](./images/trx_ids.png)
...
此刻，表 student 中`id为1的记录`得到的版本链表如下所示：
