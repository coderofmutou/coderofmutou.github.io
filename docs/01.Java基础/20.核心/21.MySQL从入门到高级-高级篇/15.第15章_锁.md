...
![MySQL_Lock_Family](./images/MySQL_Lock_Family.webp)
...
![table_read_lock](./images/table_read_lock.webp)

步骤 6：加写锁

为 mylock 表加上 write 锁，观察阻塞的情况，流程如下：

![table_write_lock](./images/table_write_lock.webp)
...
![Transaction_Wait_Chain_and_Lock_Info_Chain.webp](./images/Transaction_Wait_Chain_and_Lock_Info_Chain.webp)
...
![lock_demo6](./images/lock_demo6.webp)
...
![lock_demo7](./images/lock_demo7.webp)
...
![lock_demo9](./images/lock_demo9.webp)
