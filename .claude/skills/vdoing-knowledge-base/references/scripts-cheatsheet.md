...
本仓库 `utils/` 下三套工具包，全部通过 `npm run` 暴露稳定命令名。人和 Agent 看到的接口一致，看不到 v1/v2 残留或语言差异。
...
npm run kb:lint:one -- ../../docs/01.Java/10.基础.md
npm run kb:lint:one:fix -- ../../docs/01.Java/10.基础.md
```
